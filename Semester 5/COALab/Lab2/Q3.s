...
cont:
    ...
    li      $t3, 1                   # prod = 1
    lw $t4, 4($s0)                   # $t4 = a
    ble $t4, 0, error3               # check if a is positive
...
populate:
    ...
    addi $sp, $sp, 20               # freeing the space; deleting the stack
...
error3:
    ...
    ble $t4, 0, error3	            # if the entered number is negative
    b cont2
...
error4:
    ...
    ble $t5, 0, error4	            # if the entered number is negative
    b populate
